...
<script>
    ...
    // components
    import ModalAddUser from "../../tools/modal/user/BranchOfficeAddmin/modal-add-user-branch-office-admin.svelte";
    import ModalDeleteUser from "../../tools/modal/user/BranchOfficeAddmin/modal-delete-user-branch-office-admin.svelte";
    import ModalUpdateUser from "../../tools/modal/user/BranchOfficeAddmin/modal-update-user-branch-office-admin.svelte";
    import ModalInfoUser from "../../tools/modal/user/BranchOfficeAddmin/modal-info-user-branch-office-admin.svelte";
    ...
    import {userBranchOfficeAllData,currentIdUser,currentDatauser} from '../../../store/user/user.js'
    ...
    onMount(async ()=>{
        if($branch_officeData){
            let result = await GetAllUsers("BRANCH_OFFICE_ADMIN",$branch_officeData._id)
    ...
    $:{
        branch_office_admin_Array = $userBranchOfficeAllData
    }
