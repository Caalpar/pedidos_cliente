    ...
    const DeliveredOrder = async (order) =>{
        ...
        let newOrder ={
            ...
            if(result.create){
                ...
                if(index_order != -1){
                    $OrdersAllData.splice(index_order,1)
                    $OrdersAllData = $OrdersAllData
                }
...
<div class="carrusel">
    ...
    <div id="container" class="container" bind:this={content}>
        ...
        <div class='element'>
            ...
            <div class="letter">
                    CLIENTE: {order.id_user?.first_name ? order.id_user?.first_name : 'sin cliente' } {order.id_user?.last_name ? order.id_user?.last_name : ''}
            </div>          
            <div class="letter">
                    DIR: {order.id_user?.address ? order.id_user?.address : '' }
            </div>       
            <div class="letter">
                    TEL: {order.id_user?.phone ? order.id_user?.phone : ''}
            </div> 
            <div class="letter">
                    DELIVERY: 
