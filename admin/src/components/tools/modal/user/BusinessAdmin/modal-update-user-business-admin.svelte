<script>
    ...
    import {userBusinessAllData,currentDatauser} from '../../../../../store/user/user.js'
    ...
    const Update = async () =>{
        ...
        if(new_user.update){
            ...
            let index_user = $userBusinessAllData.findIndex(b => b._id == new_user.data._id )

            if(index_user !==-1){
                $userBusinessAllData[index_user] = new_user.data
