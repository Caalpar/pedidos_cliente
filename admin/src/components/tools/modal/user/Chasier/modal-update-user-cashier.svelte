<script>
    ...
    import {userCashierAllData,currentDatauser} from '../../../../../store/user/user.js'
    ...
    const Update = async () =>{
        ...
        if(new_user.update){
            ...
            let index_user = $userCashierAllData.findIndex(b => b._id == new_user.data._id )

            if(index_user !==-1){
                $userCashierAllData[index_user] = new_user.data
