...
<script>
    ...
    // components
    import ModalAddUser from "../../tools/modal/user/Chasier/modal-add-user-cashier.svelte";
    import ModalDeleteUser from "../../tools/modal/user/Chasier/modal-delete-user-cashier.svelte";
    import ModalUpdateUser from "../../tools/modal/user/Chasier/modal-update-user-cashier.svelte";
    import ModalInfoUser from "../../tools/modal/user/Chasier/modal-info-user-cashier.svelte";
    ...
    import {currentIdUser,currentDatauser,userCashierAllData} from '../../../store/user/user.js'
    ...
    onMount(async ()=>{
        if($branch_officeData){
            let result = await GetAllUsers("CASHIER",$branch_officeData._id)

            if(result.success)
                $userCashierAllData = result.data 
            else
                alert(result.msg)
    ...
    $:{
        branch_office_admin_Array = $userCashierAllData
    }
    ...
    const ChangeBranchOffice = async (branch_office) =>{
        ...
        let result = await GetAllUsers("CASHIER",branch_office._id)
