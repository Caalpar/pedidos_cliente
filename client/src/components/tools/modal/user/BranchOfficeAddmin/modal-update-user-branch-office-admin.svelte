<script>
    ...
    import {userBranchOfficeAllData,currentDatauser} from '../../../../../store/user/user.js'
    ...
    const Update = async () =>{
        ...
        if(new_user.update){
            ...
            let index_user = $userBranchOfficeAllData.findIndex(b => b._id == new_user.data._id )

            if(index_user !==-1){
                $userBranchOfficeAllData[index_user] = new_user.data
